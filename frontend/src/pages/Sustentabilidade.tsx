  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen pt-44 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        {/* Secção de Economia Circular Animada */}
        <motion.div 
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-50px" }}
        ...
        {/* Grelha de Certificações em Destaque Animada */}
        <motion.div 
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-50px" }}
        ...
        >
          ...
          {/* Cartão LWG */}
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-yellow-100 relative overflow-hidden group hover:shadow-lg transition-shadow">
          ...
          {/* Cartão ISO */}
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-blue-50 relative overflow-hidden group hover:shadow-lg transition-shadow">
