...
const content = {
  PT: {
    ...
    openAria: "Abrir janela do WhatsApp",
    closeAria: "Fechar janela do WhatsApp",
  },
  EN: {
    company: "Curtumes Ibéria",
    ...
    openAria: "Open WhatsApp window",
    closeAria: "Close WhatsApp window",
  }
};
